...
func RegisterClockinInterfaceHTTPServer(s *http.Server, srv ClockinInterfaceHTTPServer) {
	r := s.Route("/")
	r.POST("/api/clockin/v1/register", _ClockinInterface_Register0_HTTP_Handler(srv))
	r.POST("/api/clockin/v1/login", _ClockinInterface_Login0_HTTP_Handler(srv))
	r.GET("/api/clockin/v1/onwork", _ClockinInterface_ClockinOnWork0_HTTP_Handler(srv))
	r.GET("/api/clockin/v1/offwork", _ClockinInterface_ClockinOffWork0_HTTP_Handler(srv))
}
...
func _ClockinInterface_Register0_HTTP_Handler(srv ClockinInterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/api.clockin.interface.v1.ClockinInterface/Register")
...
func _ClockinInterface_Login0_HTTP_Handler(srv ClockinInterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/api.clockin.interface.v1.ClockinInterface/Login")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClockinInterface_ClockinOnWork0_HTTP_Handler(srv ClockinInterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/api.clockin.interface.v1.ClockinInterface/ClockinOnWork")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClockinInterface_ClockinOffWork0_HTTP_Handler(srv ClockinInterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/api.clockin.interface.v1.ClockinInterface/ClockinOffWork")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ClockinInterfaceHTTPClientImpl) ClockinOffWork(ctx context.Context, in *ClockinOffWorkRequest, opts ...http.CallOption) (*ClockinOffWorkReply, error) {
	...
	pattern := "/api/clockin/v1/offwork"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/api.clockin.interface.v1.ClockinInterface/ClockinOffWork"))
...
func (c *ClockinInterfaceHTTPClientImpl) ClockinOnWork(ctx context.Context, in *ClockinOnWorkRequest, opts ...http.CallOption) (*ClockinOnWorkReply, error) {
	...
	pattern := "/api/clockin/v1/onwork"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/api.clockin.interface.v1.ClockinInterface/ClockinOnWork"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ClockinInterfaceHTTPClientImpl) Login(ctx context.Context, in *LoginRequest, opts ...http.CallOption) (*LoginReply, error) {
	var out LoginReply
	pattern := "/api/clockin/v1/login"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/api.clockin.interface.v1.ClockinInterface/Login"))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *ClockinInterfaceHTTPClientImpl) Register(ctx context.Context, in *RegisterRequest, opts ...http.CallOption) (*RegisterReply, error) {
	...
	pattern := "/api/clockin/v1/register"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/api.clockin.interface.v1.ClockinInterface/Register"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
